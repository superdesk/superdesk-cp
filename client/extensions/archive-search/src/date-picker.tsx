...
import { Button, InputWrapper } from "superdesk-ui-framework/react";
...
interface IDatePickerBase
  extends Omit<
    InputWrapper["props"],
    "children" | "maxLength" | "value" | "htmlId" | "size" | "data-test-id"
  > {
  ...
  locale?:
    | { type: "code-only"; code: string }
    | { type: "full"; payload: Omit<LocaleSettings, "today" | "clear"> };
    ...
    return (
      ...
      >
        <Calendar
          ...
          panelClassName="archive-search__calendar-panel"
          footerTemplate={
            showClearButton
              ? () => (
