...
class BusinessWireTestCase(ParserTestCase):
    ...
    def test_parser(self):
        ...
        self.assertEqual("Interactive Brokers Lifts All Trading Restrictions on Options", item["headline"])
        self.assertEqual("Interactive Brokers lifts all trading restrictions on options", item["abstract"])
