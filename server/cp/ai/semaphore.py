...
class Semaphore(AIServiceBase):
    ...
    Environment variables SEMAPHORE_BASE_URL, SEMAPHORE_ANALYZE_URL, SEMAPHORE_SEARCH_URL, SEMAPHORE_GET_PARENT_URL , SEMAPHORE_CREATE_TAG_URL , SEMAPHORE_CREATE_TAG_TASK , SEMAPHORE_CREATE_TAG_QUERY and SEMAPHORE_API_KEY must be set.
    """
